# Manual Steps For Road Surface `FRA` (`paved / unpaved`)

Automatic download from the direct country file URL did not complete successfully.

Direct file URL:
- https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_fra_roadsurface_lines.gpkg
...
2. Place it under `data/raw/road_surface/FRA/heigit_fra_roadsurface_lines.gpkg`.
