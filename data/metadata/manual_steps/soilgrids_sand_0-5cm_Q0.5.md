# Manual Steps For SoilGrids `sand_0-5cm_Q0.5`
...
Requested layer:
- property: `sand`
- coverage id: `sand_0-5cm_Q0.5`
- bbox (WGS84): `[-69.8, -22.9, -57.4, -9.6]`

What to do:
1. Use the official SoilGrids WCS or WebDAV access method described in the docs.
2. Save the resulting file under `data/raw/soilgrids/sand_0-5cm_Q0.5.tif`.
